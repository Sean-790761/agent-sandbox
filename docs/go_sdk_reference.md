...
The Go client registers:

- `sandbox_client_create_latency_ms{status}` — `CreateSandbox` latency
- `sandbox_client_discovery_latency_ms{mode,status}` — `GetSandbox` discovery/reattach latency

See [metrics.md](metrics.md) for controller-side series.
