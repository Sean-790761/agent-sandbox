...
func TestSandboxCollector(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedCount: 1,
			expectedLabels: map[string]int{
				"created_by:unknown expired:false launch_type:cold namespace:default owned_by:None ready_condition:true sandbox_template:__unknown__": 1,
			},
		},
		{
			...
			expectedCount: 1,
			expectedLabels: map[string]int{
				"created_by:unknown expired:false launch_type:cold namespace:default owned_by:None ready_condition:false sandbox_template:__unknown__": 1,
			},
		},
		{
			...
			expectedCount: 1,
			expectedLabels: map[string]int{
				"created_by:unknown expired:false launch_type:warm namespace:default owned_by:None ready_condition:false sandbox_template:__unknown__": 1,
			},
		},
		{
			...
			expectedLabels: map[string]int{
				...
				"created_by:unknown expired:false launch_type:cold namespace:default owned_by:None ready_condition:false sandbox_template:__unknown__":    2,
			},
		},
		{
			...
			expectedCount: 1,
			expectedLabels: map[string]int{
				"created_by:unknown expired:false launch_type:cold namespace:default owned_by:SandboxClaim ready_condition:true sandbox_template:__unknown__": 1,
			},
		},
		{
			...
			expectedCount: 1,
			expectedLabels: map[string]int{
				"created_by:unknown expired:false launch_type:cold namespace:default owned_by:SandboxWarmPool ready_condition:true sandbox_template:__unknown__": 1,
			},
		},
		{
		...
		},
		{
			...
			expectedCount: 1,
			expectedLabels: map[string]int{
				"created_by:go-client expired:false launch_type:cold namespace:default owned_by:None ready_condition:true sandbox_template:__unknown__": 1,
			},
		},
		{
			...
			expectedCount: 1,
			expectedLabels: map[string]int{
				"created_by:python-client expired:false launch_type:cold namespace:default owned_by:None ready_condition:true sandbox_template:__unknown__": 1,
			},
		},
		{
